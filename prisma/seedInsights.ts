...
export async function seedInsights() {
    ...
    const insights = [
        ...
        {
            id: 'tx_refund_detected',
            name: 'Money back! 💸',
            description: 'Detects refunds matching previous purchases.',
            category: 'celebration',
            priority: 60,
            trigger: 'refund_detected',
            trigger_params: null,
            message_template: 'Nice! €{{amount}} refund for purchase from {{date}}',
            icon: 'ArrowDownLeft',
            contexts: ['transaction_row'],
            cooldown_hours: 0
        },
        {
            id: 'tx_weekend_warrior',
            name: 'Weekend mode 🎉',
            description: 'Friday/Saturday fun spending.',
            category: 'insight',
            priority: 45,
            trigger: 'weekend_warrior',
            trigger_params: null,
            message_template: '{{day}} vibes at {{merchant}}',
            icon: 'Star',
            contexts: ['transaction_row'],
            cooldown_hours: 0
        },
        {
            id: 'tx_merchant_comeback',
            name: 'Long time no see! 👋',
            description: 'Merchant visit after long absence.',
            category: 'insight',
            priority: 35,
            trigger: 'merchant_comeback',
            trigger_params: null,
            message_template: 'Back at {{merchant}} after {{timeAgo}}!',
            icon: 'RefreshCw',
            contexts: ['transaction_row'],
            cooldown_hours: 0
        },
        {
            id: 'tx_frequent_flyer',
            name: 'Regular alert 🛫',
            description: 'Regular at this merchant.',
            category: 'insight',
            priority: 40,
            trigger: 'frequent_flyer',
            trigger_params: null,
            message_template: '{{count}}th visit to {{merchant}} this month!',
            icon: 'Award',
            contexts: ['transaction_row'],
            cooldown_hours: 0
        },
        {
            id: 'tx_category_spike',
            name: 'Spending spike ⚡',
            description: 'Category spending unusually high.',
            category: 'action',
            priority: 55,
            trigger: 'category_spike',
            trigger_params: null,
            message_template: '{{category}} is {{ratio}}x your usual! (€{{currentAmount}} vs avg €{{avgAmount}})',
            icon: 'TrendingUp',
            action_label: 'View category',
            action_href: '/transactions?category={{categoryId}}',
            contexts: ['transaction_row'],
        ...
        {
            id: 'tx_holiday_trip',
            name: 'Vacation vibes 🏖️',
            description: 'Travel/foreign transaction detected.',
            category: 'insight',
            priority: 50,
            trigger: 'holiday_trip',
            trigger_params: null,
            message_template: 'Travel expense at {{merchant}} {{hint}}',
            icon: 'Plane',
            contexts: ['transaction_row'],
            cooldown_hours: 0
        },
        {
            id: 'tx_merchant_pair',
            name: 'The usual combo 🤝',
            description: 'Merchants that always appear together.',
            category: 'insight',
            priority: 30,
            trigger: 'merchant_pair',
            trigger_params: null,
            message_template: '{{merchant1}} + {{merchant2}} again! ({{count}}x this pattern)',
            icon: 'Link',
            contexts: ['transaction_row'],
            cooldown_hours: 0
        },
        // Additional transaction-level insights
        {
            id: 'tx_duplicate_check',
            name: 'Double trouble? 🔄',
        ...
        },
        {
            ...
            trigger_params: null,
            message_template: 'First time at {{merchant}}!',
            icon: 'Star',
            contexts: ['transaction_row'],
            cooldown_hours: 0
        },
        {
            ...
            trigger: 'price_hike',
            trigger_params: null,
            message_template: '{{merchant}} jumped by {{percent}}%!',
            icon: 'TrendingUp',
            contexts: ['transaction_row'],
            cooldown_hours: 0
        },
        {
            id: 'tx_salary_incoming',
            name: 'Ka-ching! 💰',
        ...
        },
        {
            ...
            trigger: 'late_night',
            trigger_params: null,
            message_template: '{{time}} snack at {{merchant}}?',
            icon: 'Moon',
            contexts: ['transaction_row'],
            cooldown_hours: 0
        },
        {
            ...
            trigger_params: null,
            message_template: '€{{amount}} exactly. Nice.',
            icon: 'CheckCircle',
            contexts: ['transaction_row'],
            cooldown_hours: 0
        },
